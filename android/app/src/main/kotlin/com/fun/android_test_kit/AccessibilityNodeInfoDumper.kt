...
object AccessibilityNodeInfoDumper {
    ...
    private fun dumpNodeRec(node: AccessibilityNodeInfo, serializer: XmlSerializer, index: Int,
        ...
        serializer.attribute("", "text", filterEmoji(safeCharSeqToString(node.text)))
        ...
        serializer.attribute("", "content-desc", filterEmoji(safeCharSeqToString(node.contentDescription)))
